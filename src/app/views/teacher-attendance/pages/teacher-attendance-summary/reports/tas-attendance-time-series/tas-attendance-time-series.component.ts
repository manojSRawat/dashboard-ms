...
@Component({
  selector: 'app-attendance-time-series',
  templateUrl: './tas-attendance-time-series.component.html',
  styleUrls: ['./tas-attendance-time-series.component.scss']
})
export class TasAttendanceTimeSeriesComponent implements OnInit {
  dummyData = [
    [
      1262304000000,
      0.7537
  ...
  reportName: string = 'tas_attendance_time_series';
  filters: any = [];
  levels: any;
  tableReportData: any;
  minDate: any;
  ...
  async getReportData(startDate = undefined, endDate = undefined): Promise<void> {
    console.log('innnn time series report data');
    ...
    Object.keys(queries).forEach((key: any) => {
      ...
      if (query && key === 'timeSeries') {
        this.getChartReportData(query, options, filters, defaultLevel);
      }
    })
  }

  getChartReportData(query, options, filters, defaultLevel): void {
